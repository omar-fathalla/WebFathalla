          ...
          >
            <div className="flex flex-wrap gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-[220px] justify-center bg-[#f8931f] hover:bg-[#db8200] text-white px-6 py-3 rounded-lg transition-colors flex items-center gap-2"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-[220px] justify-center bg-black hover:bg-gray-900 text-white px-6 py-3 rounded-lg transition-colors flex items-center gap-2"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.6 }}
              className="mt-8 bg-white/90 backdrop-blur-sm p-6 rounded-xl border border-[#f8931f]/20 shadow-lg max-w-2xl"
            >
              <div className="flex items-start gap-4">
                <div className="bg-[#f8931f]/10 p-3 rounded-full text-[#f8931f] shrink-0">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-[#502800] mb-2">
                    {/* @ts-ignore */}
                    {t(hero.ecommerceTitle, lang)}
                  </h3>
                  <p className="text-[#713d00] text-sm leading-relaxed text-justify">
                    {/* @ts-ignore */}
                    {t(hero.ecommerceDesc, lang)}
                  </p>
                </div>
              </div>
            </motion.div>
